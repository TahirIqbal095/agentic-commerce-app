...
When one message requests multiple Cart Mutations, return every operation in requestedCartMutations. Use ADD with a Product ID from the latest Recommendation Set and its quantity, REMOVE with the explicit Cart Item Product name, CHANGE_QUANTITY with the explicit Cart Item Product name and its RELATIVE or EXACT change, and CLEAR by itself. Preserve all requested operations; application code validates conflicts and applies the whole batch atomically. Do not combine CLEAR with another Cart Mutation.
